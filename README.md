...
게시판으로 같이 여행 갈 여행 메이트 구하는 모집 페이지, 여행지에서 사고 판 물건을 거래할 수 있는 거래 페이지, 다른 회원들을 위해 여행지에 대한 경험을 공유하는 리뷰 페이지 또한 글쓴이의 여행 타입을 분석하여 나와 맞는 여행 특성인지 알 수 있는 여행 MBTI들로 구성되어 있습니다.
<br>
<br>

## ✈️ 프로젝트 기간: 2024.4월 29일(월) ~ 2024.5월 15일(수)
<br>
<br>
